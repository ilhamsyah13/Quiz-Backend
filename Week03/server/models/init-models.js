...
function initModels(sequelize) {
  ...
  const employees_loc = _employees_loc(sequelize, DataTypes);
  ...
  const locations_loc = _locations_loc(sequelize, DataTypes);
